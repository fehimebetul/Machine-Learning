...
class DataSet(object):
    ...
    def next_batch(self, batch_size, fake_daata=False):
...
def read_data_sets(train_dir, fake_data=False, one_hot=False,
    ...
    all_images = numpy.load('/Users/macbook/PycharmProjects/tensorflow/regresiion/fileRegres.npy')
    #all_images = all_images.reshape(all_images.shape[0], all_images.shape[1], all_images.shape[2],all_images.shape[3], 1)

    train_labels_original = numpy.load('/Users/macbook/PycharmProjects/tensorflow/regresiion/mat_contentsRegres.npy')
